...
export const createEsewaSchema = (baseUrl: string)=>
    z.object({
        ...
        success_url: z.url().default(`${baseUrl}/user/payment/success`),
        failure_url: z.url().default(`${baseUrl}/user/payment/failed`),
